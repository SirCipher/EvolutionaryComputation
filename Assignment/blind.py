...
# TODO: ADD A CHECK THAT THERE ARE ENOUGH SPACES LEFT FOR THE FOOD (IF THE TAIL IS VERY LONG)
# TODO: Stop snake from running itself over
# TODO: Look at novelty search, coevolutionary algorithms
# TODO: Change to using strongly typed
# TODO: Add in another evaluation function. Maybe return a sum of squares?
# TODO: Try to reduce the function set
# TODO: Remove eaSimple and migrate to a manually written algorithm
# TODO: Wall sensing seems to be off for the left hand side of the grid
# TODO: Snake seems to be doing well at running itself over
# TODO: New scoring system doesn't work so well when the snake is long. It will lose a lot of it's score
# TODO: Sensing to the right doesn't seem to be working. Direction left/right isn't implemented?
...
def evaluate(ind):
    ...
    for i in range(nrun):
        coverage = run_game(ind)

    return coverage / nrun,
...
def main():
    ...
    with open('axis_range_normal.txt', 'w') as f:
